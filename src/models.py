...
import datetime
# Si hago cambios en la BD, realizo el procecso para actualizarla y aun asi no se actualiza hay que seguir los pasos de RESET_MIGRATION de la carpeta docs
db = SQLAlchemy()
...
class Characters(db.Model):
    ...
    info_type = db.Column(db.String(20), default="character")
...
class Planet(db.Model):
    ...
    info_type = db.Column(db.String(20), default="planet")
...
class Vehicle(db.Model):
    ...
    created = db.Column(db.Date)
    edited = db.Column(db.Date)
    info_type = db.Column(db.String(20), default="vehicle")
